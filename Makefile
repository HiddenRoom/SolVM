...
emutest: src/VM.c src/include/VM.h src/interrupt.c src/include/interrupt.h src/instruction.c src/include/instruction.h src/VMtest.c
	$(CC) $(CFLAGS) -c -o VM.o src/VM.c
	$(CC) $(CFLAGS) -c -o interrupt.o src/interrupt.c
	$(CC) $(CFLAGS) -o VMtest.out VM.o interrupt.o src/VMtest.c
